...
| [`.github/workflows/server-installer-test.yml`](.github/workflows/server-installer-test.yml) | Install and boot exported Bluefin Server artifacts with QEMU/KVM |
